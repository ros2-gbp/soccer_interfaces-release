...
Name:           ros-rolling-soccer-geometry-msgs
Version:        1.0.0
Release:        1%{?dist}%{?release_suffix}
Summary:        ROS soccer_geometry_msgs package
...
%description
A package containing msgs that extend geometry_msgs for use in soccer-related
packages
